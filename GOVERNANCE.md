...
`cloud-itonami-iso3166-kir` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Kiribati-licensed counsel or a registered agent for whatever licensed
representation the law of the Republic of Kiribati requires for

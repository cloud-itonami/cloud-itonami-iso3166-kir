(ns marketentry.store
  "SSoT for the Republic of Kiribati (KIR) market-entry compliance actor,
...
(defn demo-data
  ...
  `:declared-procurement-tier` / `:declared-procurement-value-aud` /
  `:declared-procurement-monthly-rate-aud` /
  `:declared-procurement-duration-months` are ground truth for the
  `procurement-tier-understated` flagship check (Public Procurement
  Manual 2020 §7.1.6 four-tier AUD ladder, with its own accumulation
  rule for recurring engagements); `:foreign-investor?` /
  `:declared-activity` are ground truth for the `reserved-activity-
  violation` check (Foreign Investment Guideline Schedule 1);
  `:requires-tin-record?` / `:tin-record-verified?` are ground truth
  for the conditional Kiribati Tax Division TIN check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Bairiki Fabrication Ltd" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :declared-procurement-tier :mvp :declared-procurement-value-aud 25000.0
             :foreign-investor? false :declared-activity nil
             :requires-tin-record? true :tin-record-verified? true
             :drafted? false :submitted? false
             :jurisdiction "KIR" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :declared-procurement-tier :mvp :declared-procurement-value-aud 25000.0
             :foreign-investor? false :declared-activity nil
    ...
    "eng-3" {:id "eng-3" :operator "Betio Logistics Co-operative" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "KIR" :status :intake}
    "eng-4" {:id "eng-4" :operator "Tarawa Consulting Services" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ;; Manual §7.1.6's OWN worked example: AUD 4,000/month x 18
             ;; months = AUD 72,000 (HVP), declared here as LVP -- the
             ;; understated-tier scenario the flagship check catches.
             ...
             :drafted? false :submitted? false
             :jurisdiction "KIR" :status :intake}
    "eng-5" {:id "eng-5" :operator "Kiritimati Trading Ltd" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :declared-procurement-tier :mvp :declared-procurement-value-aud 25000.0
             :foreign-investor? false :declared-activity nil
             ...
             :drafted? false :submitted? false
             :jurisdiction "KIR" :status :intake}
    "eng-6" {:id "eng-6" :operator "Pacific Rim Ventures Pte Ltd" :portal "www.procurement.gov.ki"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :declared-procurement-tier :mvp :declared-procurement-value-aud 25000.0
             ;; Schedule 1 Reserved List: taxi transport services reserved
             ;; for Kiribati citizens only.
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               declared-procurement-tier declared-procurement-value-aud
                               declared-procurement-monthly-rate-aud declared-procurement-duration-months
                               foreign-investor? declared-activity
  ...
  (cond-> {:engagement/id id}
    ...
    declared-procurement-tier             (assoc :engagement/declared-procurement-tier declared-procurement-tier)
    (some? declared-procurement-value-aud) (assoc :engagement/declared-procurement-value-aud declared-procurement-value-aud)
    (some? declared-procurement-monthly-rate-aud) (assoc :engagement/declared-procurement-monthly-rate-aud declared-procurement-monthly-rate-aud)
    (some? declared-procurement-duration-months) (assoc :engagement/declared-procurement-duration-months declared-procurement-duration-months)
    (some? foreign-investor?)             (assoc :engagement/foreign-investor? foreign-investor?)
    declared-activity                     (assoc :engagement/declared-activity declared-activity)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/declared-procurement-tier :engagement/declared-procurement-value-aud
   :engagement/declared-procurement-monthly-rate-aud :engagement/declared-procurement-duration-months
   :engagement/foreign-investor? :engagement/declared-activity
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :declared-procurement-tier (:engagement/declared-procurement-tier m)
     :declared-procurement-value-aud (:engagement/declared-procurement-value-aud m)
     :declared-procurement-monthly-rate-aud (:engagement/declared-procurement-monthly-rate-aud m)
     :declared-procurement-duration-months (:engagement/declared-procurement-duration-months m)

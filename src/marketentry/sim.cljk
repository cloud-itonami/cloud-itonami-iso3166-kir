(ns marketentry.sim
  ...
  commit), then shows HARD-hold scenarios, including this vertical's
  flagship procurement-tier-understated check and the reserved-
...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (KIR, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up procurement-tier-understated -- FLAGSHIP) ==")
    ...
    (println "== filing/submit eng-4 (declared LVP but AUD4,000/month x 18 months = AUD72,000 accumulated -> HVP; HARD hold) ==")
    ...
    (println "== jurisdiction/assess eng-6 (sets up reserved-activity-violation) ==")
    ...
    (println "== filing/submit eng-6 (foreign investor declaring taxi-transport-services, a Schedule 1 Reserved activity -> HARD hold) ==")
